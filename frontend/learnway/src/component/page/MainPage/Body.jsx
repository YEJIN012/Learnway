...
const BtnSection = styled.div`
    border-top: 1px solid rgba(83, 83, 83, 0.8);
    height: 40%;
    display: flex;
    flex-direction: row;
    align-items: center;
...
function Body() {
    ...
    useEffect(() => {
        dispatch({
            type: "matchLangUpdate",
            payload: { languageId: null, languageName: "TO" },
        });
    }, []);
            ...
            <SelectSection>
                ...
                <SelectFrame>
                    ...
                    <Modal open={popup} onClose={popupClose}>
                        <Box
                            sx={languagestyle}
                            style={{ outline: "none", borderRadius: "16px" }}
                        >
            ...
            <BtnSection>
                ...
                >
                    <Box sx={camStyle}>
                        ...
                        >
                            {t(
                                "Before entering the conversation, you can check and check the status of the webcam."
                            )}
                        </Typography>
                        <Typography
